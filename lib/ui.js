...
import { useState, useContext } from '../node_modules/preact/hooks/dist/hooks.js';
...
addTags(`
    div a p h1 h2 h3 h4 h5 span ul ol li strong aside button
`);

$.render = (...args) => p.render(...args);
$.useState = (...args) => useState(...args);
